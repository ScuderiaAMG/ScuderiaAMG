...
public class BoxTest_mimofixed {                                     // 主类（public），用于测试泛型方法和泛型类
    public static void main(String[] args) {               // 主方法：程序执行的入口点
        ...
        integerBox.add(Integer.valueOf(10));                   // 向盒子中添加Integer对象（值为10），使用valueOf替代废弃的构造函数
        ...
        integerBox.inspect(Double.valueOf(100.0));             // 调用泛型方法inspect，传入Double类型参数（U被推断为Double），使用valueOf替代废弃的构造函数
    }
}
