...
public class ListTestWithGenerics_mimofixed {                        // 主类（public），演示使用泛型的集合
    public static void main(String[] args) {               // 主方法：程序执行的入口点
        ...
        listofInteger.add(Integer.valueOf(2000));              // 向集合中添加Integer对象（值为2000），使用valueOf替代废弃的构造函数
        listofInteger.add(Integer.valueOf(8));                            // 添加Integer对象8，使用valueOf替代废弃的构造函数
