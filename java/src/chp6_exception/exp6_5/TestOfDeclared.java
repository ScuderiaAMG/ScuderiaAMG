...
public class TestOfDeclared {                               // 公开测试类TestOfDeclared
    public static void main(String[] args) {                // 程序入口点
        try {                                               // try块开始：调用可能抛出异常的方法
            ListOfNumbersDeclared list = new ListOfNumbersDeclared(); // 创建ListOfNumbersDeclared实例
