...
tmux send-keys -t ros_session:0.3 'sleep 5; source ~/endurance_ws/devel/setup.zsh; roslaunch yolov8_ros ros_predict.launch' C-m
...
tmux send-keys -t ros_session:2.2 'sleep 7; source ~/endurance_ws/devel/setup.zsh; roslaunch mission circle.launch' C-m
