...
tmux send-keys -t ros_session:1.1 'sleep 5; source ~/endurance_ws/devel/setup.bash; roslaunch cloud_recognition all_noflag_rviz.launch' C-m
...
tmux send-keys -t ros_session:1.3 'sleep 5; ls' C-m
