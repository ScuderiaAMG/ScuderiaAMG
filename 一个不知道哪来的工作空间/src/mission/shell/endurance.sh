...
tmux send-keys -t ros_session:0.1 'sleep 3; source ~/endurance_ws/devel/setup.zsh; roslaunch bringup location.launch' C-m

# Pane 2: simple_camera_driver.launch
tmux split-window -v -t ros_session:0.1
tmux send-keys -t ros_session:0.2 'sleep 4; source ~/endurance_ws/devel/setup.zsh; roslaunch usb_cam simple_camera_driver.launch' C-m

# Pane 3: ros_predict.launch
tmux split-window -v -t ros_session:0.2
tmux send-keys -t ros_session:0.3 'sleep 5; source ~/endurance_ws/devel/setup.zsh; roslaunch yolov8_ros ros_predict_endurance.launch' C-m
...
tmux send-keys -t ros_session:2.1 'sleep 6; source ~/endurance_ws/devel/setup.zsh; rostopic echo /object_position' C-m

# Pane 3: complete_mission.launch
tmux split-window -v -t ros_session:2.1
tmux send-keys -t ros_session:2.2 'sleep 7; source ~/endurance_ws/devel/setup.zsh; roslaunch mission endurance.launch' C-m
