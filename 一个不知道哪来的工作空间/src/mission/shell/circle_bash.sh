...
tmux send-keys -t ros_session:0.1 'source ~/endurance_ws/devel/setup.bash; roslaunch bringup location.launch' C-m
...
tmux send-keys -t ros_session:1.1 'sleep 5; source ~/endurance_ws/devel/setup.bash; roslaunch mission trajectory.launch' C-m
...
tmux send-keys -t ros_session:2.2 'sleep 7; source ~/endurance_ws/devel/setup.bash; roslaunch mission circle.launch' C-m
