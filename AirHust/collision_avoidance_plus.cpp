...
void collision_avoidance(float target_x, float target_y)
{
   ...
   /* for (int i = 0; i < 2; i++)
    ...
    if (flag_collision_avoidance.data == true)
    {
        ...
        vel_collision[0] = satfunc(vel_collision[0], vel_collision_max * cos(Euler_fcu[2] / 180 * M_PI));
        vel_collision[1] = satfunc(vel_collision[1], vel_collision_max * sin(Euler_fcu[2] / 180 * M_PI));
    }
    for (int i = 0; i < 2; i++)
    {
    ...
    vel_sp_ENU[0] = satfunc(vel_sp_body[0], vel_sp_max * cos(Euler_fcu[2] / 180 * M_PI));
    vel_sp_ENU[1] = satfunc(vel_sp_body[1], vel_sp_max * sin(Euler_fcu[2] / 180 * M_PI));
